...
export const metadata: Metadata = {
  ...
  description:
    'The advice that sounds sensible, is repeated everywhere, and is quietly wrong.',
  alternates: { canonical: '/resources/credit-score-myths' },
  openGraph: {
        ...
        <Container maxWidth="narrow">
          <article className="prose prose-lg max-w-none">
            <div className={cn(TYPOGRAPHY.body, "text-gray-700 space-y-4 md:space-y-6")}>
              ...
              <div className="bg-brand-50 p-6 md:p-8 rounded-lg my-6 md:my-8">
