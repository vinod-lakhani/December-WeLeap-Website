      ...
      <Section variant="muted" className="text-center">
        <Container maxWidth="narrow">
          ...
          <div className="flex justify-center gap-4">
            <a href="#" className="text-gray-600 hover:text-brand-700 transition-colors duration-200" aria-label="Share on Facebook">
              <Facebook className="w-6 h-6" />
            </a>
            <a href="#" className="text-gray-600 hover:text-brand-700 transition-colors duration-200" aria-label="Share on Twitter">
              <Twitter className="w-6 h-6" />
            </a>
            <a href="#" className="text-gray-600 hover:text-brand-700 transition-colors duration-200" aria-label="Share on LinkedIn">
              <Linkedin className="w-6 h-6" />
            </a>
            <a href="#" className="text-gray-600 hover:text-brand-700 transition-colors duration-200" aria-label="Share via Email">
