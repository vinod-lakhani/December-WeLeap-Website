  ...
  return (
    <PageShell className="bg-canvas">
      ...
      <Section variant="canvas" className="text-center" isHero>
        <Container>
          <div className="inline-flex items-center gap-2 bg-brand-50 border border-brand-100 text-brand-700 px-3 md:px-4 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-semibold mb-6 md:mb-8">
          ...
          <h1 className="text-balance text-[clamp(2.2rem,4vw,3.4rem)] font-extrabold leading-[1.06] tracking-[-0.035em] text-ink mb-4 md:mb-6">
            Everything works toward one clear next step.
          </h1>

          <p className={cn(TYPOGRAPHY.body, "text-subtle mb-8 md:mb-10 max-w-3xl mx-auto leading-relaxed")}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <EarlyAccessDialog signupType="product-features-hero" placement="hero">
              <Button className="bg-brand-700 text-white hover:bg-brand-800 px-8 py-[17px] rounded-full font-bold shadow-pill transition hover:-translate-y-px">
                Create free account
              </Button>
            </EarlyAccessDialog>
            <Link
              href="/pricing"
              className="inline-flex items-center justify-center px-6 py-[17px] rounded-full font-bold text-brand-700 border border-brand-100 hover:bg-brand-700/5 transition-colors"
            >
              See pricing <ArrowRight className="w-3 h-3 md:w-4 md:h-4 ml-2" />
            </Link>
          </div>

          <p className={cn(TYPOGRAPHY.subtext, "text-faint mt-3 md:mt-4")}>No spam. Transparent from day one.</p>
        </Container>
      </Section>
            ...
            <Card className={cn(CARD_STYLES.base, "p-4 md:p-5")}>
              <CardContent className="p-0">
                <div className="flex items-start gap-2 md:gap-3">
                  <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 mt-0.5 text-brand-700 flex-shrink-0" />
                  <div>
            ...
            <Card className={cn(CARD_STYLES.base, "p-4 md:p-5 sm:col-span-2 md:col-span-1")}>
              <CardContent className="p-0">
                <div className="flex items-start gap-2 md:gap-3">
                  <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 mt-0.5 text-brand-700 flex-shrink-0" />
                  <div>
                    <p className={cn("font-semibold text-gray-900", TYPOGRAPHY.subtext)}>You approve every move</p>
                    <p className={cn("text-gray-600", TYPOGRAPHY.subtext)}>Nothing happens to your money without you.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <Container>
          <div className="max-w-5xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 bg-brand-50 text-brand-700 px-3 md:px-4 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-medium mb-4 md:mb-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 mt-0.5 text-brand-700" />
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-brand-600 to-brand-700 rounded-2xl p-6 shadow-2xl">
                  <video
        ...
        <Container>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <EarlyAccessDialog signupType="product-features-cta" placement="cta_section">
              <Button className="bg-brand-700 hover:bg-brand-800 text-white px-9 py-[17px] rounded-full font-bold shadow-pill transition hover:-translate-y-px">
                Get your first Leap →
              </Button>
            </EarlyAccessDialog>
            <Link
