...
export async function generatePlanPDFBuffer(planData: PlanData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    try {
      ...
      doc.fontSize(7).font('Times-Roman').fillColor('#9ca3af').text('Educational estimate — not financial advice. Numbers may vary based on withholding, benefits, and timing.', { align: 'center', y: footerY, width: pageWidth });
